    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_title_subtitle', models.BooleanField(default=True)),
                ('show_project_highlight', models.BooleanField(default=True)),
                ('show_technology', models.BooleanField(default=True)),
                ('show_some_projects', models.BooleanField(default=True)),
